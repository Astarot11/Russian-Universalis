...
static const float3 MAP_LIGHT_DIFFUSE			= float3( 1.05f, 1.0f, 1.0f );
static const float  MAP_LIGHT_INTENSITY   		= 1.35f;
static const float  MAP_AMBIENT					= 0.35f;
static const float	LIGHT_HDR_RANGE 			= 1.7f;
...
static const float 	WATER_TILE					= -0.75f;
static const float 	WATER_TIME_SCALE			= 3.0f;
