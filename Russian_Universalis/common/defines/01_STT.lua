...
NDefines.NEconomy.BASE_INTERESTS = 4.5							-- Base interests increase from 4 to 4.5
NDefines.NEconomy.INFLATION_FROM_LOAN = 0.15 					-- from 0.1 to 0.15
...
--NDefines.NCountry.REVOLT_TECH_IMPACT = 0.004
